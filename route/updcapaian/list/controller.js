define([
    ...
    'component/alt/button/service',
    'component/iconplus/updcapaian/vcapaianaktivitas'
], function(moment){
    return ['$scope', '$route', '$routeParams', '$log', '$button', '$auth', '$window', '$alert', '$validate', '$popup', 'Iconplus_Updcapaian_Vcapaianaktivitas',
        function($scope, $route, $routeParams, $log,  $button, $auth, $window, $alert, $validate, $popup, Iconplus_Updcapaian_Vcapaianaktivitas){
        //moment
        moment.locale('id');
        $scope.moment = moment;
        ...
        $scope.toolbar = {
         ...
         $scope.refunit = {};
            Iconplus_Updcapaian_Vcapaianaktivitas.keyval().then(function(response){
        ...
        $scope.table = {
            ...
            reload: function () {
                ...
                $scope.table.isloading = Iconplus_Updcapaian_Vcapaianaktivitas.table(param);
        ...
        $scope.btnadd = $button('add', {
            ...
            href: alt.baseUrl + 'updcapaian/detail?action=add'
        });
        ...
        $scope.btnedit = function (index, item) {
            return $button('edit', {
                ...
                href: alt.baseUrl + 'updcapaian/detail?action=edit&unitid=' + item.unitid
            });
        };
        ...
        $scope.btnview = function (index, item) {
            return $button('view', {
                ...
                href: alt.baseUrl + 'updcapaian/detail?action=view&unitid=' + item.unitid
            });
        };
                        ...
                        buttons: [
                            $button('yes', {
                                onclick: function () {
                                    ...
                                    Iconplus_Updcapaian_Vcapaianaktivitas.update({
                                    isdeleted: 1,
