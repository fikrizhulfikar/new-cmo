define([
    ...
    return ['$scope', '$routeParams', '$log', '$button', '$timeout', '$validate', '$window', '$alert', 'Iconplus_Master_Unit', 'Iconplus_View_Regional',
    function($scope, $routeParams, $log, $button, $timeout, $validate, $window, $alert, Iconplus_Master_Unit,Iconplus_View_Regional){
        $scope.detail = {
            action: $routeParams.action,
            id_regional: $routeParams.id_regional
        };
        $scope.toolbar = {
            title: 'Unit',
        ...
        if($scope.action != 'add')  Iconplus_View_Regional.retrieve({id_regional: $scope.detail.id_regional}).then(function(response){
        ...
        $scope.btncancel = $button('cancel', {
            href : alt.baseUrl + 'master/regional/list'
        });
