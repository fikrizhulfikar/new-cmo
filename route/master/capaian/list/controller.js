...
define([
    ...
    return ['$scope', '$route', '$routeParams', '$log', '$button', '$auth', '$window', '$alert', '$validate', '$popup', 'Iconplus_Master_Vprojectstream','Iconplus_Master_Vprojectstream',
        ...
        $scope.breadcrumb = {
            data: [{
                ...
                title: 'Pengelolaan Capaian',
                url: alt.baseUrl + 'master/vprojectstream/list',
                isactive: true
            }]
        };
                ...
                onclick: function(){ 
                    if(state == 'add'){
                        ...
                        var isvalid = $validate()
                            .rule($validate.required($scope.capaian.nama_stream), 'Harap isi stream terlebih dahulu!')
                            .rule($validate.required($scope.capaian.capaian), 'Harap isi capaian terlebih dahulu!')
