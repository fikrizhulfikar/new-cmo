define([
    ...
    return ['$scope', '$routeParams', '$log', '$button', '$auth', '$popup', 'Iconplus_Master_Unit','Iconplus_View_Regional','Iconplus_View_NamaPembangkit',
        function($scope, $routeParams, $log, $button, $auth, $popup, Iconplus_Master_Unit,Iconplus_View_Regional,Iconplus_View_NamaPembangkit){
        // toolbar
        ...
        $scope.table = {
            ...
            reload: function () {
                ...
                $scope.table.isloading = Iconplus_View_NamaPembangkit.table(param);
        ...
        $scope.btnedit = function (index, item) {
            return $button('edit', {
                ...
                href: alt.baseUrl + 'master/pembangkit/detail?action=edit&unitid=' + item.unitid
            });
        };
        ...
        $scope.btnview = function (index, item) {
            return $button('view', {
                ...
                href: alt.baseUrl + 'master/pembangkit/detail?action=view&nama_pembangkit=' + item.nama_pembangkit+'&id_wilayah='+item.id_wilayah
            });
        };
        ...
        $scope.btnremove = function (index, item) {
            return $button('remove', {
                ...
                onclick: function () {
                    $popup.confirm({
                        caption: "Anda yakin akan menghapus pembangkit : " + item.name + " ?",
                        buttons: [
                            $button('yes', {
                                onclick: function () {
