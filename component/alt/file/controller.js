define([
    ...
    return ['$scope', '$log', '$element', function($scope, $log, $element){
        ...
        $scope.ismulti = $scope.ismulti || false;
        $scope.forceHost = $scope.forceHost|| "";
        ...
        $scope.onchange = function(element){
            ...
            var file;
            if($scope.ismulti) file = angular.element($scope.element)[0].files;
            else file = angular.element($scope.element)[0].files[0];
