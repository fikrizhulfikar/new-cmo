define([
    ...
    return ['$scope', '$routeParams', '$log', '$button', '$auth', '$popup', 'Pusharlis_Master_Act_Process','Pusharlis_Master_Penugasan',
        function($scope, $routeParams, $log, $button, $auth, $popup, Pusharlis_Master_Act_Process,Pusharlis_Master_Penugasan){
            $scope.$auth = $auth;
            ...
            $scope.table = {
                ...
                reload: function(){
                    ...
                    $scope.table.isloading = Pusharlis_Master_Act_Process.table(param);
